...
void MSDelay(DWORD d) { Sleep(d); }

void typeOut(string text, DWORD sleepms = 18, DWORD aftersleep = 0) {
    for (char c : text) {
        cout << c;
        if (!(GetKeyState(VK_LEFT) & 0x8000) && isAlphabet(c)) {
            MSDelay(sleepms);
        }
    }
    cout << "\n";
...
string optionsNav(map<string, string> options, map<string, string> specialOptions, string option = "select", bool (*func1)(int) = nullptr, bool (*func2)(int) = nullptr) {
    ...
    while (!(GetKeyState(VK_RIGHT) & 0x8000)) {
        if (rerender) {
            ...
            goBack((SHORT)(options.size() + specialOptions.size()));
        }
...
bool inventoryHas(int item) {
    if (count(inventory.begin(), inventory.end(), item)) { return true; }
    else { return false; }
}
...
string minigameVis[][23] = {
    {"33333333333333333333333333333333333333333333333333333333333333333333",
     "33333333333111111333333333333333333333333333333333311113333333333333",
     "33333333111111111133333333333333333333333333333333111111333333111333",
     "33331111333311111333333333333333333333333333333333311113333331111133",
     "33311111113333333333333333333333333333333333333333333333333333311133",
     "33333111133333333333333333333333333333333333333333333333333333333333",
     "33333333333333333111113333333333333311111133333333333333333333333333",
     "00000000000000011111111122222222222111111111222011111110000000000000",
     "00000000000011111111111112222222221111111111111111111111110000000000",
     "00000000001111111111111111222222111111111111111111111111111000000000",
     "00000000001111111111111111222211111111111111111211111111111100000000",
     "00000000001111111111111111122211111111111111122211111111111111000000",
     "00000000011111111111111111122221111111111111122221111111111111100000",
     "00000000000111111111111111122221111111111111222221111111111111100000",
     "00000000000211111111111111222221111111111122222222211111111111100000",    // 0 ; Which ore?
     "00000000002222111111111112222222111111112222222222222211111111000000",
     "00000000222222222222222222222222222222222222222222222222222200000000",
    ...
    {"33333333333333333333333333333333333333333333333333333333333333333333",
     ...
     "33311111113333333333333333333333333333333333333333333333333333311133",
     "33333111133333333333333333333333333333333333333333333333333333333333",
     "33333333333333333333333333333333333311111133333333333333333333333333",
     "00000000000000000000002222222222222111111111222011111110000000000000",
     "00000000000011100000221112222222221111111111111111111111110000000000",
     "00000000001111110022221111222222111111111111111111111111111000000000",
     "00000000001111111222111111222211111111111111111211111111111100000000",
     "00000000001111111221111111122211111111111111122211111111111111000000",
     "00000000011111111111111111122221111111111111122221111111111111100000",
     "00000000000111111111111111122221111111111111222221111111111111100000",
     "00000000000211111111111111222221111111111122222222211111111111100000",    // 1 ; First boulder empty
     "00000000002222111111111112222222111111112222222222222211111111000000",
     "00000000222222222222222222222222222222222222222222222222222200000000",
     "00000022222222222222222222222222222222222222222222222222222222000000",
     "00000222222222222222222222222222222222222222222222222222222222200000",
    ...
    {"33333333333333333333333333333333333333333333333333333333333333333333",
     ...
     "33311111113333333333333333333333333333333333333333333333333333311133",
     "33333111133333333333333333333333333333333333333333333333333333333333",
     "33333333333333333111113333333333333333333333333333333333333333333333",
     "00000000000000011111111122222222211122222211222011111110000000000000",
     "00000000000011111111111112222222111122222211111111111111110000000000",
    ...
    {"33333333333333333333333333333333333333333333333333333333333333333333",
     ...
     "00000000000011111111111112222222221111111111111111122011110000000000",
     "00000000001111111111111111222222111111111111111111122011111000000000",
     "00000000001111111111111111222211111111111111111211114441111100000000",
     "00000000001111111111111111122211111111111111122211111444111111000000",
     "00000000011111111111111111122221111111111111122221114144411111100000",
     "00000000000111111111111111122221111111111111222221111141141111100000",
     "00000000000211111111111111222221111111111122222222211114111111100000",    // 6 ; Third builder gold
     "00000000002222111111111112222222111111112222222222222241111111000000",
     "00000000222222222222222222222222222222222222222222222222222200000000",
     "00000022222222222222222222222222222222222222222222222222222222000000",
     "00000222222222222222222222222222222222222222222222222222222222200000",
     "00022222222222222222222222222222222222222222222222222222222222222000",
...
string minigameToString(int minigamenmr) {
    ostringstream os;
    for (int i = 0; i < (int)lengthof(minigameVis[minigamenmr]); i++) {
...
//  hp, attackdurance, attackdmg, type, difficulty, dmgrange, resistance, coinrewardmin, coinrewardmax
    {50, 200, 1, 0, 1, 0, 0, 0, 0},         // enemy #0
    {100, 200, 10, 0, 2, 10, 0, 1, 3},      // enemy #1
    {100, 400, 20, 0, 2, 20, 0, 2, 4},      // enemy #2
    {150, 300, 20, 0, 3, 30, 20, 3, 5},     // enemy #3
    {200, 300, 20, 0, 4, 20, 30, 3, 5},     // enemy #4
    {100, 300, 5, 1, 1, 10, 0, 1, 5},       // enemy #5
    {150, 300, 30, 1, 2, 20, 0, 3, 5},      // enemy #6
    {200, 300, 20, 1, 3, 50, 20, 4, 5},     // enemy #7
    {200, 300, 30, 1, 4, 20, 10, 3, 8},     // enemy #8
    {100, 300, 20, 2, 1, 20, 0, 1, 5},      // enemy #9
    {150, 300, 20, 2, 2, 20, 30, 3, 6},     // enemy #10
    {150, 300, 20, 2, 3, 20, 20, 2, 5},     // enemy #11
    {200, 300, 20, 2, 4, 20, 40, 4, 7},     // enemy #12
    {180, 100, 40, 1, 10, 40, 30, 10, 10},   // enemy #13
};
    ...
    while (!retreat && opponenthealth > 0 && health > 0) {
        ...
        if (input == "r") {
            ...
            while (!exit) {
                ...
                while (!(GetKeyState(VK_RIGHT) & 0x8000)) {
                    if (rerender) {
                        ...
                        goBack((SHORT)specialOptions.size());
                    }
                    if (GetKeyState(VK_UP) & 0x8000)
                        if (iteration > 0) {
                            while (GetKeyState(VK_UP) & 0x8000) {}
            ...
            if (opponenthealth == 0) {
                attack = false;
                srand((unsigned)time(0));
                int coinreward = (rand() % (opponents[opponentnmr][8] - opponents[opponentnmr][7] + 1)) + opponents[opponentnmr][7];
                coins += coinreward;
        ...
        if (attack) {
            ...
            if (opponents[opponentnmr][3] == 0) { // is attack type spikes?
                map<int, int> spikesX;
                map<int, int> spikesY;
                map<int, int> spikesY2;
                map<int, int> spikesY3;
                int chanceofspike = 1;
                ...
                while (attackFrames != 0 && health > 0) {
                    ...
                    if (afkSpikeDelayX == 0) {
                        afkSpikeDelayX = (rand() % afkSpikeDelayMaxX);
                        if (opponents[opponentnmr][4] > 1) {
                            int point1 = playerX;
                            if (spikesX[point1] == 0) // is this spike already claimed?
                                spikesX[point1] = rows * spikeMove + (rand() % afkSpikeDelayMaxX) * spikeMove; // Fall ; with custom delay
                        }
                    }
                    else
                        afkSpikeDelayX -= 1;
                    if (afkSpikeDelayY == 0) {
                        afkSpikeDelayY = (rand() % afkSpikeDelayMaxY);
                        if (opponents[opponentnmr][4] > 1) {
                            int point2 = playerY;
                    ...
                    // spikes X
                    srand((unsigned)time(0));
                    if (rand() % chanceofspike == 0) { // Is there going to be spike(s) summoned?
                        for (int i = 0; i < ammountSpikesX; i++) {
                            int point3 = rand() % charPerRow; // Grab random spike pos
                            if (spikesX[point3] == 0) // is this spike already claimed?
                                spikesX[point3] = rows * spikeMove + (rand() % maxSpikeCooldown) * spikeMove;
                        }
                    }
                    // spikes Y
                    if (opponents[opponentnmr][4] > 1) {
                        ...
                        for (int i = 0; i < ammountSpikesY; i++) {
                            int point4 = rand() % rows; // Grab random spike pos
                    ...
                    if (opponents[opponentnmr][4] > 2 && spikes2Countdown == 0) {
                        srand((unsigned)time(0));
                        for (int i = 0; i < ammountSpikesY; i++) {
                            int point5 = rand() % rows; // Grab random spike pos
                    ...
                    if (opponents[opponentnmr][4] > 3 && spikes3Countdown == 0) {
                        srand((unsigned)time(0));
                        for (int i = 0; i < ammountSpikesY; i++) {
                            int point6 = rand() % rows; // Grab random spike pos
                    ...
                    // spike update
                    // X
                    for (auto const& x : spikesX)
                    {
                        if (spikesX[x.first] > 0) {
                            int value = spikesX[x.first] / spikeMove;
                            if (value > rows - 1)
                                spikesVis[x.first][0] = 1;
                            else
                                spikesVis[x.first][rows - value] = 1;
                            spikesX[x.first] -= 1;
                        }
                    }
                    // Y 1
                    if (opponents[opponentnmr][4] > 1) {
                        for (auto const& x : spikesY)
                        {
                            if (x.second > 0) {
                                int value = x.second / spikeMove;
                                if (value > charPerRow - 1)
                                    spikesVis[0][x.first] = 1;
                                else
                                    spikesVis[charPerRow - value][x.first] = 1;
                                spikesY[x.first] -= 1;
                            }
                        }
                    }
                    ...
                    if (spikesVis[playerX][playerY] == 1 && attackFrames > 0) // hit?
                        if (invincibilityFrames == 0) { // player must not be invincible
                            ...
                            if (opponents[opponentnmr][5] != 0) { // random damage range?
                                srand((unsigned)time(0));
                                attackDamage += (rand() % opponents[opponentnmr][5] + 1) - opponents[opponentnmr][5] / 2; // pick number between 1 - damage range, subtract by damage range / 2
                            }
                    ...
                    if ((GetKeyState(VK_UP) & 0x8000) && playerY != 0 && attackFrames > 0)
                        playerY -= 1;
                    if ((GetKeyState(VK_DOWN) & 0x8000) && playerY != rows - 1 && attackFrames > 0)
                        playerY += 1;
                    if ((GetKeyState(VK_LEFT) & 0x8000) && playerX != 0 && attackFrames > 0)
                        playerX -= 1 * speedmul;
                    if ((GetKeyState(VK_RIGHT) & 0x8000) && playerX != charPerRow - 1 && attackFrames > 0)
                        playerX += 1 * speedmul;
                    // render health bar
                    cout << endl;
                    ...
                    goBack(rows + 3);
                    if ((t - ((clock() - start) / (double)(CLOCKS_PER_SEC))) * 1000 > 0)
                        Sleep((DWORD)((t - ((clock() - start) / (double)(CLOCKS_PER_SEC))) * 1000));
                    t += dt;
                }
            ...
            if (opponents[opponentnmr][3] == 1) { // is attack type bombs?
                ...
                while (attackFrames != 0 && health > 0) {
                    ...
                    // bombs
                    srand((unsigned)time(0));
                    if (rand() % chanceofbomb == 0) { // Is there going to be a bomb summoned?
                        for (int i = 0; i < ammountbombs; i++) {
                            int point = rand() % charPerRow; // Grab random bomb pos
                            if (bombs[point][0] == 0) { // is this bomb already claimed?
                                bombs[point][0] = rows * bombMove + (rand() % maxBombCooldown) * bombMove;
                                bombs[point][1] = 0 - (rows - 1 - rand() % (int)(rows - rows / 3));
                            }
                        }
                    }
            ...
            if (opponents[opponentnmr][3] == 2) { // is attack type snakes? 
                ...
                for (int i = 0; i < (int)lengthof(positionsX); i++) {
                    positionsX[i] = 0 - (rand() % randomSnakeCountdown);
                    if (rand() % randomSnakeIgnorance == 0)
                        snakeMoveX[i] = 1 + (rand() % (randomSnakeMoveMax * 5));
                    else
                        snakeMoveX[i] = 0;
                    directionsX[i] = rand() % 2;
                }
                int positionsY[rows]{};
                int snakeMoveY[rows]{};
                int directionsY[rows]{};
                for (int i = 0; i < (int)lengthof(positionsY); i++) {
                    positionsY[i] = 0 - (rand() % randomSnakeCountdown);
                    snakeMoveY[i] = 1 + (rand() % randomSnakeMoveMax);
                    directionsY[i] = rand() % 2;
                }
...
void possibleEncounter() {
    ...
    if (possibleEncounters[stage][lengthof(possibleEncounters[stage]) - 1] != 0)
        if (rand() % possibleEncounters[stage][lengthof(possibleEncounters[stage]) - 1] == 0 )
            battle(possibleEncounters[stage][rand() % (lengthof(possibleEncounters[stage])-1)]);
}
...
void moveDirection(int direction, string name) {
    if (stamina == 0) { 
        ...
        if (state < 0) { // dead end
            ...
            prevstage = stage;
            stage = state;
            if (stageEncounters[state] != 0) {
                system("CLS");
                typeOut(stageDialogue[state] + " [Press Enter]");
                getCin();
                defeated = battle(stageEncounters[state] - 1);
                if (defeated)
                    stageEncounters[state] = 0;
            }
        }
    }
}
...
void music() {
    ...
    LPCWSTR allmusic[] = {
            TEXT("Music\\Stan Leonard - Cat spirit.wav"),
            TEXT("Music\\Stan Leonard - Did you know.wav"),
            TEXT("Music\\Stan Leonard - Let it go.wav"),
            TEXT("Music\\Stan Leonard - Let's go.wav"),
            TEXT("Music\\Stan Leonard - Time will tell.wav")
    };
    srand((unsigned)time(0));
    while (true) {
        PlaySound(allmusic[rand() % lengthof(allmusic)], NULL, SND_SYNC);
        MSDelay(1000);
    }
}
